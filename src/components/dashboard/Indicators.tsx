...
const indicators: Indicator[] = [
  { name: "CO₂ emitido", value: "1.234,00 t", trend: "+2%", color: "danger" },
...
const pieColors = ["#ff8800", "#ffb347", "#2563eb", "#facc15"];

const Indicators: React.FC = () => (
  <div className="space-y-6 w-full">
    <h1 className="text-2xl font-semibold">Indicadores y Gráficos</h1>
    <div className="mb-6">
      <h2 className="font-bold text-lg mb-2">Indicadores</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {indicators.map((indicator, idx) => (
          <div key={idx} className="flex flex-col items-center p-4 rounded-xl shadow bg-white dark:bg-carbonDark">
    ...
    <div className="bg-white dark:bg-carbonDark rounded-xl shadow p-4 mb-6">
      <h2 className="font-bold text-lg mb-2">Emisiones mensuales proyectadas</h2>
    ...
    <div className="bg-white dark:bg-carbonDark rounded-xl shadow p-4 mb-6">
      <h2 className="font-bold text-lg mb-2">Distribución de iniciativas de mitigación</h2>
    ...
    <div className="bg-white dark:bg-carbonDark rounded-xl shadow p-4 mb-6">
      <h2 className="font-bold text-lg mb-2">Metas vs. Emisiones reales</h2>
      <div className="h-48 xs:h-64 sm:h-80">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={goalsData}>
            ...
            <Bar dataKey="real" fill="#ff8800" name="Real" />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
    <div className="bg-white dark:bg-carbonDark rounded-xl shadow p-4 mb-6">
      <h2 className="font-bold text-lg mb-2">Alertas mensuales</h2>
      <div className="h-48 xs:h-64 sm:h-80">
        <ResponsiveContainer width="100%" height="100%">
